    ...
    <form method="POST" action="/admin/settings/update" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2"><label class="block text-sm font-medium text-gray-700 mb-1">Shipping Banner Text</label><input type="text" name="shipping_banner_text" value="<?= e($settings['shipping_banner_text'] ?? 'Free shipping on orders over KSh 5,000') ?>" placeholder="e.g. Free shipping on orders over KSh 5,000" class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm"></div>
            </div>
        </div>
