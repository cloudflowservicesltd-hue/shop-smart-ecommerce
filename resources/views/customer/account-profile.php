...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="lg:w-64 shrink-0">
            <div class="bg-white border border-gray-200 rounded-2xl p-6 sticky top-36">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="/account/profile" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium bg-amber-50 text-amber-700 transition-colors">
        ...
        <div class="flex-1 min-w-0">
            <h1 class="font-heading text-2xl font-bold text-gray-900 mb-6">Edit Profile</h1>

            <!-- Edit Profile Form -->
            <div class="bg-white border border-gray-200 rounded-2xl p-6">
                <div class="flex items-center gap-2 mb-6">
                    <i data-lucide="user-pen" class="w-5 h-5 text-amber-600"></i>
                ...
                <form method="POST" action="/account/profile">
                    ...
                    <div class="grid sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="<?= e($user['email'] ?? '') ?>" disabled readonly
