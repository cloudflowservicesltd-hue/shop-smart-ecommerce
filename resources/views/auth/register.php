    ...
    <div class="w-full max-w-md">
        ...
        <form method="POST" action="/register" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="referral_code" class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 uppercase tracking-wider" placeholder="Enter referral code e.g. REFXXXXXXXX" value="<?= e(Request::query('ref', '')) ?>">
